...
const extractChannels = ($) => __awaiter(void 0, void 0, void 0, function* () {
    let channels = [];
    for (let anchor of $(".panel-body a")) {
        const source = (yield (0, axios_1.default)(host + anchor.attribs.href)).data;
        const url = (0, cheerio_1.load)(source)("video source").get(0).attribs.src;
